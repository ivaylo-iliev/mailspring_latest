...
curl -L "https://github.com/Foundry376/Mailspring/releases/download/$LATEST_RELEASE/mailspring-$LATEST_RELEASE-amd64.deb" --output "mailspring-$LATEST_RELEASE-amd64.deb"
